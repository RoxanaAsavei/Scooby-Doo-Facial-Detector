...
solution_path_root = "../../save/"
ground_truth_path_root = "../../testare-gt/"
...
ground_truth_path = ground_truth_path_root + "task2_daphne_gt_testare.txt"
...
ground_truth_path = ground_truth_path_root + "task2_shaggy_gt_testare.txt"
evaluate_results_task2(solution_path, ground_truth_path, "shaggy", verbose)

ground_truth_path = ground_truth_path_root + "task2_velma_gt_testare.txt"
evaluate_results_task2(solution_path, ground_truth_path, "velma", verbose)

# bonus task 1
#change this on your machine
# solution_path_root = "../../task1_yolo/"
# ground_truth_path_root = "../../validare/"

# #task1
# solution_path = solution_path_root + "save/"
# ground_truth_path = ground_truth_path_root + "task1_gt_validare.txt"
# evaluate_results_task1(solution_path, ground_truth_path, verbose)

#task2

# solution_path = "../../task2_yolo/save/"
# ground_truth_path_root = "../../validare/"
